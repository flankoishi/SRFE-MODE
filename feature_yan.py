...
def get_picture(pic_name, transform):
    ...
    img = skimage.transform.resize(img, (224, 224))  # 读入图片时将图片resize成(256,256)的
...
pic_dir = 'D:/yangben/Train_ds/Fenyanfe/1_fy_11_1.jpg'
transform = transforms.ToTensor()
img_f = get_picture(pic_dir, transform)
# 插入维度
...
#net = torchvision.models.resnet101(weights=models.ResNet101_Weights.DEFAULT).to(device)
net = yanshi_resnet().to(device)
#dst = './feautures'
dst = 'F:/feature_1'
therd_size = 224
